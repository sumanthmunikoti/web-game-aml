 ...
 */
@WebServlet("/findInsuranceAgents")
public class FindInsuranceAgents extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindInsuranceAgents() throws FileNotFoundException{
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			insAgentReturnString = Jconnector.findInsAgents();
